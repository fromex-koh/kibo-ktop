...
const controlSwitchClassName =
    'peer group/switch focus-visible:outline-ring data-[state=checked]:bg-primary data-[state=unchecked]:bg-foreground-subtle data-disabled:bg-control-disabled data-[disabled]:bg-control-disabled disabled:bg-control-disabled disabled:data-[state=checked]:bg-control-disabled disabled:data-[state=unchecked]:bg-control-disabled data-disabled:data-[state=checked]:bg-control-disabled data-disabled:data-[state=unchecked]:bg-control-disabled [&>[data-slot=switch-thumb]]:bg-surface data-disabled:[&>[data-slot=switch-thumb]]:bg-surface data-[disabled]:[&>[data-slot=switch-thumb]]:bg-surface disabled:[&>[data-slot=switch-thumb]]:bg-surface dark:data-disabled:[&>[data-slot=switch-thumb]]:bg-disabled-subtle dark:data-[disabled]:[&>[data-slot=switch-thumb]]:bg-disabled-subtle dark:disabled:[&>[data-slot=switch-thumb]]:bg-disabled-subtle relative inline-flex shrink-0 items-center rounded-full border border-transparent p-1 transition-colors focus-visible:border-transparent focus-visible:ring-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-solid disabled:opacity-100 data-disabled:opacity-100 data-[disabled]:opacity-100'
