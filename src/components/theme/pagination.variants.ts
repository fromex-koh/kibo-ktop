...
//   좌우 여백 8px·아이콘과 글자 사이 4px — Figma pagination_item 의 pre/next 폭 68px(8+20+4+28+8) 기준.

const paginationFocusClassName =
    'outline-ring focus-visible:outline-ring outline-none focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-solid'
...
const paginationNavClassName = `${paginationFocusClassName} typo-body-xl-medium text-label-foreground hover:bg-muted disabled:text-disabled inline-flex h-10 cursor-pointer items-center gap-1 rounded-sm px-2 whitespace-nowrap transition-colors select-none disabled:cursor-not-allowed disabled:hover:bg-transparent [&_svg]:pointer-events-none [&_svg]:shrink-0`
