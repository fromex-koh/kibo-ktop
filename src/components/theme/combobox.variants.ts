...
const comboboxInputClassName =
    'w-full gap-1.5 overflow-hidden [&_svg]:size-5 [&_svg]:text-foreground group-has-disabled/input-group:[&_svg]:text-disabled [&_[data-slot=input-group-button]]:size-5 [&_[data-slot=input-group-button]]:min-h-0 [&_[data-slot=input-group-button]]:min-w-0 [&_[data-slot=input-group-button]]:rounded-none [&_[data-slot=input-group-button]]:bg-transparent [&_[data-slot=input-group-button]]:p-0 [&_[data-slot=input-group-button]:hover]:bg-transparent [&_[data-slot=input-group-button]:active]:bg-transparent in-data-[slot=field]:has-[[data-slot=input-group-control]:focus-visible]:outline-none'
