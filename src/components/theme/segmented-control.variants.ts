...
const segmentedControlRadioItemStateClassName =
    'has-[[data-state=checked]]:bg-surface has-[:focus-visible]:outline-ring has-disabled:border-disabled-subtle has-disabled:bg-control-disabled-subtle has-disabled:text-disabled has-disabled:cursor-not-allowed has-disabled:shadow-none has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-offset-2 has-[:focus-visible]:outline-solid has-[[data-disabled][data-state=checked]]:bg-control-disabled-subtle has-[[data-disabled][data-state=checked]]:shadow-none has-[[data-state=checked]]:shadow-sm'
