    ...
    <nav aria-label="바로가기">
        {links.map((link) => (
            <a
                ...
                className="bg-bolder text-background focus-visible:ring-focus focus-visible:ring-offset-background z-skiplink fixed top-3 left-3 -translate-y-20 rounded-md px-4 py-2 font-semibold transition-transform duration-200 ease-out focus:translate-y-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 motion-reduce:transition-none"
            >
                {link.label}
            </a>
        ))}
