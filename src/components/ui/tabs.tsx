...
import {tabsContentClassName, tabsListVariants, tabsTriggerClassName, tabsTriggerLineClassName, tabsTriggerPillClassName, tabsTriggerPillOutlineClassName, tabsTriggerTextClassName} from '@/components/theme/tabs.variants'
...
function TabsTrigger({className, ...props}: React.ComponentProps<typeof TabsPrimitive.Trigger>) {
    return <TabsPrimitive.Trigger data-slot="tabs-trigger" className={cn(tabsTriggerClassName, tabsTriggerLineClassName, tabsTriggerTextClassName, tabsTriggerPillClassName, tabsTriggerPillOutlineClassName, className)} {...props} />
}
