        ...
        <div className="bg-background text-foreground min-h-screen">
            ...
            요소(색상 스와치 등)가 위로 새는 것을 막는다. z-[숫자] 하드코딩이 아닌 토큰이라 [CD-002] 준수. */}
                <button
                    ...
                    aria-hidden="true"
                    tabIndex={-1}
                    className={`top-header-top z-drawer-backdrop pc:hidden bg-overlay-lg fixed inset-x-0 bottom-0 transition-opacity duration-200 motion-reduce:transition-none ${
