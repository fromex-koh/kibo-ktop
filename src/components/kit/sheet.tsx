...
// PROJECT-STYLE: Sheet overlay를 Dialog overlay와 동일한 bg-overlay-xl scrim으로 맞추고 blur를 제거한다.
...
function SheetOverlay({className, ...props}: React.ComponentProps<typeof SheetPrimitive.Overlay>) {
    return (
        <SheetPrimitive.Overlay
            ...
            className={cn(
                'data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 bg-overlay-xl fixed inset-0 z-50 duration-100',
                className,
            )}
            {...props}
        />
