...
export const TECH_EVAL_CTA_FILL_CLASS =
    'border-transparent bg-muted text-foreground bg-linear-to-r from-action-fill-hover to-action-fill-hover bg-left bg-no-repeat bg-[length:0_100%] font-bold transition-[background-size,color] duration-300 interactive:hover:bg-muted interactive:hover:bg-[length:100%_100%] interactive:active:bg-gray-50'
