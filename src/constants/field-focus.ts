...
// 한 줄 wrapper 모서리는 컨트롤 형태를 따른다: checkbox 는 rounded-2xs, radio·switch 는 pill 형태의 rounded-full.
// FieldContent가 있는 설명형 항목은 높이가 커지므로 컨트롤 모양을 그대로 확장하지 않고 컨테이너용 rounded-sm을 쓴다.
