...
const SectionHeaderGuidePage = () => (
    ...
    >
        ...
        <section aria-labelledby="sh-vs-pageheader" className="flex flex-col gap-4">
            <div>
                <h2 id="sh-vs-pageheader" className="typo-h4-bold">
                    PageHeader 와의 차이
                </h2>
            </div>
            <div className="bg-background border-border overflow-x-auto rounded-md border">
                <table className="w-full text-left">
                    <caption className="sr-only">SectionHeader와 PageHeader 비교</caption>
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr className="border-border bg-background border-b last:border-b-0">
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">h1</td>
                        ...
                        <tr className="border-border bg-background border-b last:border-b-0">
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">
                                variant 로 선택(Display/L/bold 등)
                            </td>
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">
                                고정(Heading/H4/bold + Body/XL/Regular)
                            </td>
                        </tr>
                        <tr className="border-border bg-background border-b last:border-b-0">
                            <th
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">gap-1</td>
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">gap-2(8px)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
