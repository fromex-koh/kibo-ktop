...
const SubSectionHeaderGuidePage = () => (
    ...
    >
        ...
        <section aria-labelledby="ssh-vs-sectionheader" className="flex flex-col gap-4">
            <div>
                <h2 id="ssh-vs-sectionheader" className="typo-h4-bold">
                    SectionHeader 와의 차이
                </h2>
            </div>
            <div className="bg-background border-border overflow-x-auto rounded-md border">
                <table className="w-full text-left">
                    <caption className="sr-only">SubSectionHeader와 SectionHeader 비교</caption>
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr className="border-border bg-background border-b last:border-b-0">
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">h2</td>
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">h3</td>
                        </tr>
                        <tr className="border-border bg-background border-b last:border-b-0">
                            <th
                                scope="row"
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">
                                Heading/H4/bold(24px)
                            </td>
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">Title/L/bold(20px)</td>
                        </tr>
                        <tr className="border-border bg-background border-b last:border-b-0">
                            <th
                                scope="row"
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">gap-y-2(8px)</td>
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3">gap-y-1.5(6px)</td>
                        </tr>
                        <tr className="border-border bg-background border-b last:border-b-0">
                            <th
                                scope="row"
                            ...
                            <td className="typo-body-l-regular text-muted-foreground px-4 py-3" colSpan={2}>
                                동일 — text-foreground(제목)·text-foreground-subtle(설명),{' '}
                                <code className="font-mono">*Action</code> 슬롯 유무에 따라 자동 2열/세로 전환
                            </td>
                        </tr>
                    </tbody>
                </table>
