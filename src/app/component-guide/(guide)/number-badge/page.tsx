...
// 숫자 배지 — Figma "badge_number" 반영. 개수/카운트를 원형 pill 로 표시하는 작은 배지.
const NumberBadgeGuidePage = () => (
    <GuidePageShell
        title="숫자 배지 (NumberBadge)"
        description="개수·카운트를 원형 pill 로 표시하는 작은 배지입니다. 텍스트 배지(Badge)와 달리 숫자 전용이라 패딩이 좁고 색은 두 가지(primary·new)뿐입니다. 제목 옆 건수, 탭·메뉴의 알림 개수 등에 씁니다."
    >
