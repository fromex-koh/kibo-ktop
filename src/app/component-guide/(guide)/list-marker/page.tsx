...
const PROPS_ITEMS = [
    {
        name: 'type',
        description: '불릿 계열(unordered)과 순서 계열(ordered)을 선택합니다.',
        type: "'unordered' | 'ordered'",
        defaultValue: "'unordered'",
    },
    {
        name: 'level',
        description: '뎁스. level 1은 점·숫자, level 2는 대시·소문자로 표시합니다.',
        type: '1 | 2',
        defaultValue: '1',
    },
    {
        name: 'index',
        description: 'ordered 순번(1부터). level 2는 a–z로 표시하고 26을 넘으면 숫자로 대체합니다.',
        type: 'number',
        defaultValue: '1',
    },
    {
        name: 'className',
        description: '마커 바깥 span에 추가할 클래스입니다.',
        type: 'string',
        defaultValue: '-',
    },
] as const
        ...
        <section aria-labelledby="lm-props" className="flex flex-col gap-4">
            ...
            <div className="border-border overflow-x-auto rounded-md border">
                <table className="w-full text-left">
                    <caption className="sr-only">ListMarker Props 목록</caption>
                    <thead>
