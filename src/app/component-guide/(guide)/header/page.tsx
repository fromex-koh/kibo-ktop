            ...
            <section aria-labelledby="sh-preview" className="flex flex-col gap-4">
                <div>
                    ...
                    <p className="typo-body-l-regular text-muted-foreground">
                        ...
                        구성입니다. 헤더에서 선택한 기업/기관 유형은 주 메뉴와 전체 메뉴에 함께 반영되며, 전체 메뉴 안에는
                        화면 유형 컨트롤을 중복 배치하지 않습니다. 화면 폭을 lg(≥1024) 미만으로 줄이면 주 메뉴와 유틸 링크는
                        전체 메뉴로 이동합니다. 테마 전환은 showThemeToggle prop으로 노출 여부를 정하며, 라이트 모드에서는
                        달, 다크 모드에서는 해 아이콘으로 다음 전환 상태를 안내합니다. 전체 메뉴는 화면 전체를 덮고 트리거는
                        Menu에서 X로 전환됩니다. 트리거는 열린 메뉴보다 높은 위계를 유지해 같은 위치에서 다시 눌러 닫을 수
                        있으며, 모션 축소 설정에서는 애니메이션 없이 상태만 바뀝니다.
                    </p>
                </div>
                <HeaderDemo />
            ...
            <section aria-labelledby="sh-a11y" className="flex flex-col gap-4">
                ...
                <ul className="typo-body-l-regular text-muted-foreground flex list-disc flex-col gap-2 pl-5">
                    ...
                    <li>
                        ...
                        즉시 확인할 수 있습니다. 열린 동안 기존 헤더 링크는 탭 순서에서 제외되므로 Tab을 누르면 전체 메뉴의
                        첫 링크로 이동합니다. 마지막 링크 다음과 첫 링크 이전에는 X 버튼으로 포커스가 순환하며, Esc로도 닫을
                        수 있습니다. [8.2.1]
                    </li>
