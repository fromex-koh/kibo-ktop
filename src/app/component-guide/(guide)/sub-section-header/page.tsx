        ...
        <section aria-labelledby="ssh-demo" className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="typo-body-l-regular text-muted-foreground">
                    ...
                    <code className="font-mono">size=&quot;xs&quot;</code>(32px) 로, SectionHeader(md·40px)보다 한 단계
                    작다.
                </p>
            </div>
            <BaseCard>
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="typo-body-l-regular text-muted-foreground">
                    ...
                    <code className="font-mono">ListMarker level=&#123;2&#125;</code>(대시 불릿) 리스트로 바꿉니다. 한
                    항목 안에서 <code className="font-mono">&lt;br /&gt;</code> 로 줄을 나누면, 이어지는 줄은 대시
                    너비만큼 들여써 텍스트를 같은 선에 맞춥니다.
                </p>
            </div>
            <BaseCard>
                <SubSectionHeader>
