    ...
    >
            ...
            <section aria-labelledby="skip-nav-usage" className="flex flex-col gap-4">
                <div>
                    ...
                    <p className="typo-body-l-regular text-muted-foreground">
                        ...
                        페이지를 새로 연 뒤 <kbd className="font-mono">Tab</kbd> 키를 누르면 화면 상단에
                        &quot;사이드메뉴 바로가기&quot;, &quot;본문 바로가기&quot; 링크가 순서대로 나타납니다.
                    </p>
                </div>
        ...
        <BaseCard>
            <section aria-labelledby="skip-nav-structure" className="flex flex-col gap-4">
                ...
                <ul className="typo-body-l-regular text-muted-foreground flex list-disc flex-col gap-2 pl-5">
                    ...
                    <li>
                        이동 대상은 <code className="font-mono">id</code>와{' '}
                        <code className="font-mono">tabIndex=-1</code>을 함께 가져야 키보드 포커스 대상이 됩니다.
                    </li>
                    <li>
                    ...
                    <li>
                        시각 스타일은 Button <code className="font-mono">default/lg</code>를 재사용하되, SkipNav 전용
        ...
        <BaseCard>
            <section aria-labelledby="skip-nav-accessibility" className="flex flex-col gap-4">
                ...
                <ul className="typo-body-l-regular text-muted-foreground flex list-disc flex-col gap-2 pl-5">
                    <li>
                        링크들은 <code>nav[aria-label=&quot;바로가기&quot;]</code> 안에 전달된 배열 순서대로
                        렌더링됩니다.
                    </li>
                    <li>
                    ...
                    <li>
                        <code>onSelect</code>에서 <code>preventDefault()</code>를 호출하지 않으면 기본 fragment 이동도
                        함께 실행됩니다.
                    </li>
                </ul>
            </section>
            ...
            <section aria-labelledby="skip-nav-props" className="flex flex-col gap-4">
                ...
                <div className="bg-background border-border overflow-x-auto rounded-md border">
                    <table className="w-full text-left">
                        ...
                        <tbody>
                            {PROPS_ITEMS.map(
                                ({component, name, type, defaultValue, required, description, ...item}) => (
                                    <tr
                                        key={`${component}-${name}`}
