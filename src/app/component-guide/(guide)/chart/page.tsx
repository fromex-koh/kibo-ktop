...
const PROPS_ITEMS = [
    ...
    [
        'ComparisonRadarChart',
        'primaryLabel',
        '범례·툴팁·숨김 데이터 표에 표시할 주 대상의 이름을 전달합니다.',
        '-',
        'string',
    ],
    [
        'ComparisonRadarChart',
        'comparisonLabel',
        '비교 대상의 이름입니다. 주면 점선 계열이 함께 그려지고, 주지 않으면 주 계열만 그립니다.',
        'undefined',
        'string',
    ],
    ['ComparisonRadarChart', 'showLegend', '차트 위 범례 표시 여부를 설정합니다.', 'true', 'boolean'],
    [
        'ComparisonRadarChart',
        'showDots',
        '꼭짓점의 점을 표시합니다. 값을 표로 따로 보여 줄 때는 끕니다.',
        'true',
        'boolean',
    ],
    ...
    [
        'ComparisonRadarChart',
        'centerY',
        '다각형 중심의 세로 위치입니다. 축 이름이 위아래로 잘릴 때 조정합니다.',
        '그릴 자리의 한가운데',
        'number | string',
    ],
    ['ComparisonRadarChart', 'margin', '차트가 앉는 자리의 여백입니다.', '{20, 48, 20, 48}', 'object'],
    [
        'ComparisonRadarChart',
        'tickFontSize · tickFontWeight',
        '축 이름의 글자 크기와 굵기입니다.',
        '12 · 600',
        'number',
    ],
    [
        'ComparisonRadarChart',
        'showTooltip',
        '값 위에 올렸을 때 뜨는 말풍선입니다. 끄면 호버 때 나타나는 강조도 함께 사라집니다.',
        'true',
        'boolean',
    ],
    ...
    [
        'GroupedColumnChart',
        'showAxes',
        '축·눈금선 표시 여부입니다. 항목 이름과 값을 표가 따로 보여 줄 때 꺼서 막대만 남깁니다.',
        'true',
        'boolean',
    ],
    [
        'GroupedColumnChart',
        'showTrack',
        '막대 뒤에 최댓값까지의 옅은 기둥을 깔아 눈금 없이도 높이를 견주게 합니다.',
        'false',
        'boolean',
    ],
    [
        'GroupedColumnChart',
        'maxBarSize',
        '막대 하나의 최대 두께(px)입니다. 좁은 열에 넣을 때 줄입니다.',
        '32',
        'number',
    ],
    [
    ...
    [
        'LineChart',
        'showAxes',
        '축·눈금선 표시 여부입니다. 항목 이름과 값을 표가 따로 보여 줄 때 꺼서 선만 남깁니다.',
        'true',
        'boolean',
    ],
    [
        'LineChart',
        'strokeDasharray',
        "선을 점선으로 그립니다(예: '4 4'). 측정값이 아니라 흐름을 보이는 선일 때 씁니다.",
        'undefined',
        'string',
    ],
