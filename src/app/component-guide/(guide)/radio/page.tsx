            ...
            <section aria-labelledby="radio-demo" className="flex flex-col gap-4">
                <div>
                    ...
                    <p className="typo-body-l-regular text-muted-foreground">
                        <code className="font-mono">RadioGroup</code> 안에{' '}
                        <code className="font-mono">RadioGroupItem</code> 을 넣어 단일 선택을 만듭니다. shadcn{' '}
                        <code className="font-mono">Field</code> 안에서 <code className="font-mono">FieldLabel</code>의{' '}
                        <code className="font-mono">htmlFor</code>와 <code className="font-mono">RadioGroupItem</code>의{' '}
                        <code className="font-mono">id</code>를 연결합니다. 프로젝트 Radio 크기는 24px로 고정되어 별도의{' '}
        ...
        <BaseCard>
            <section aria-labelledby="radio-form" className="flex flex-col gap-4">
                <div>
                    ...
                    <p className="typo-body-l-regular text-muted-foreground">
                        실제 <code className="font-mono">form</code> 안에서{' '}
                        <code className="font-mono">RadioGroup</code>에 <code className="font-mono">name</code>, 각{' '}
                        <code className="font-mono">RadioGroupItem</code>에 고유한{' '}
                        <code className="font-mono">value</code>를 지정하면 선택값 하나가 제출됩니다.{' '}
                        ...
                        번째 필수 그룹으로 포커스를 이동하며, 1depth는 선택지 아래에, 2depth는 설명이 포함된 선택지
                    ...
                    <div className="bg-surface border-border mt-3 flex flex-col gap-1 rounded-md border p-4">
                        ...
                        <p className="typo-body-l-regular text-muted-foreground">
                            ...
                            제외됩니다. 실제 조작 요소인{' '}
                            <code className="font-mono">button[role=&quot;radio&quot;]</code>는 연결된 Label을 통해 접근
                            가능한 이름을 제공하므로 실제 사용자 접근성에 영향을 주지 않는 자동 검사 오탐으로 판단하여
                            예외 처리합니다.
                        </p>
                    </div>
                </div>
