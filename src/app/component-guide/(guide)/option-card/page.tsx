...
const USAGE_CODE = `<OptionCard
  ...
  illustration={<Image src={ktrsIllust} alt="" draggable={false} width={148} height={100} />}
/>`
...
<div className="grid gap-4 md:grid-cols-2">
  <OptionCard href="/evaluation/ktrs-fm" badge="기술평가" title="KTRS-FM 평가" subtitle="표준 기술금융 모형"
    description="..." illustration={<Image src={ktrsIllust} alt="" draggable={false} width={148} height={100} />} />
  <OptionCard href="/evaluation/tech-index" badge="혁신평가" title="창업용 Tech-Index" subtitle="창업기업용"
    description="..." illustration={<Image src={techIllust} alt="" draggable={false} width={148} height={100} />} />
  {/* … */}
</div>`
