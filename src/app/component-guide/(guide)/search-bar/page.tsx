    ...
    >
        ...
        <section aria-labelledby="sb-state" className="flex flex-col gap-4">
            <div>
                ...
                <p className="typo-body-l-regular text-muted-foreground">
                    기본·값 입력됨·오류·비활성 상태입니다. 별도의 size prop 없이 프로젝트 검색창 규격 하나를 사용하며,
                    SearchBar에서는 readOnly 상태를 제공하지 않습니다.
                </p>
            </div>
        ...
        <section aria-labelledby="sb-form" className="flex flex-col gap-4">
            <div>
                ...
                <p className="typo-body-l-regular text-muted-foreground">
                    <code className="font-mono">name</code>을 지정하면 네이티브 input 값이 FormData에 포함됩니다. 예시는
                    필수값을 검증해 <code className="font-mono">FieldError</code>를 연결하고 첫 오류 입력으로 포커스를
                    이동합니다.
                </p>
            </div>
            <SearchBarFormDemo />
