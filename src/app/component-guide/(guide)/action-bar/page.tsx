        ...
        <section aria-labelledby="ab-start-end" className="flex flex-col gap-4">
            <div>
                ...
                <p className="typo-body-l-regular text-muted-foreground">
                    <code className="font-mono">ActionBarStart</code>·<code className="font-mono">ActionBarEnd</code>만
        ...
        <section aria-labelledby="ab-center" className="flex flex-col gap-4">
            <div>
                ...
                <p className="typo-body-l-regular text-muted-foreground">
                    ...
                    <code className="font-mono">ActionBarStart</code>/<code className="font-mono">ActionBarEnd</code>가
                    없어도 컨테이너 정중앙에 옵니다(양 옆 컬럼이 똑같이 빈 1fr 이라 항상 반씩 나뉘기 때문). 자가진단
