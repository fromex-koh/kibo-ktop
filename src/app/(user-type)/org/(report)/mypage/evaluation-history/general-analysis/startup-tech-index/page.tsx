...
// 기관 평가결과 조회 > 일반분석 > 창업용 Tech-Index — 아직 시안이 없어 빈 화면으로 둔다.
//
...
const OrgMypageEvaluationHistoryGeneralAnalysisStartupTechIndexPage = () => (
    <main id="main" tabIndex={-1} className="bg-background min-h-dvh">
        {/* 화면에 보이는 제목이 없어도 제목이 하나도 없는 페이지가 되지 않게 이름만 남긴다[6.4.2]. */}
        <h1 className="sr-only">창업용 Tech-Index 일반분석</h1>
    </main>
)
