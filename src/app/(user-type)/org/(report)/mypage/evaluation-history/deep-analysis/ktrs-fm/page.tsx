...
const OrgMypageEvaluationHistoryDeepAnalysisKtrsFmPage = async () => {
    const report = await getEvaluationReport('ktrs-fm', 'deep')

    return <EvaluationReportScreen title="KTRS-FM 심층분석" report={report} />
}

export default OrgMypageEvaluationHistoryDeepAnalysisKtrsFmPage
