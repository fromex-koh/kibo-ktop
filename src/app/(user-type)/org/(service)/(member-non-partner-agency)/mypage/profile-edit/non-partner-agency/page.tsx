...
// 기관 마이페이지 내 정보 — 비협약 기관으로 로그인했을 때.
// 칸 구성은 협약기관과 같고, 협약할 때 정해지는 [평가사업 선택] 칸만 없다(시안 케이스 A).
const OrgMypageProfileNonPartnerAgencyPage = () => (
    <OrgMypageProfileScreen
        member={ORG_MYPAGE_MEMBERS.nonPartnerAgency}
        form={<OrgMypageProfileForm account={ORG_MEMBER_ACCOUNTS.nonPartnerAgency} />}
    />
)

export default OrgMypageProfileNonPartnerAgencyPage
