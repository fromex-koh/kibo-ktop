...
const MOCK_FAQ_ITEMS: readonly FaqItem[] = [
    {
        ...
        answer: 'K-TOP은 기관의 기술평가 업무와 관련 서비스를 지원하는 플랫폼입니다.',
    },
    {
        id: 'org-faq-002',
    ...
    {
        id: 'org-faq-003',
        question: '평가 업무는 어디에서 확인하나요?',
        answer: '로그인 후 평가 메뉴에서 담당 업무와 진행 현황을 확인할 수 있습니다.',
    },
    {
        id: 'org-faq-004',
...
export default OrgNoticeFaqPage
