...
import {MANUFACTURING_CHECKLIST} from '@/content/technology-evaluation/industry-checklist'
...
const COMPLETE_PATH = '/org/individual-evaluation/investment-model/complete'
// 폼 바깥에 있는 [다음] 버튼을 form 속성으로 잇는 이름.
const FORM_ID = 'checklist-form'

// 기관 개별평가 투자모형 (3) 체크리스트 입력 — 업종코드가 제조일 때의 화면.
// 기업 화면과 같은 구성이고 문항도 같다(투자모형·KTRS-FM 이 같은 체크리스트를 쓴다).
...
const OrgInvestmentModelChecklistManufacturingPage = () => (
    <main id="main" tabIndex={-1} className="bg-background flex-1">
        ...
        <div className="grid-layout gap-y-10 pt-10 *:col-span-full">
            ...
            <div className="mt-5">
                <ChecklistForm
                    data={MANUFACTURING_CHECKLIST}
                    id="checklist"
                    formId={FORM_ID}
                    completeHref={COMPLETE_PATH}
                />
            </div>
        </div>
...
export default OrgInvestmentModelChecklistManufacturingPage
