...
// 기관 개별평가 투자모형 (5) 완료 화면 — Figma "투자모형_4단계_제출 완료".
// 기업 투자모형 완료 화면과 같은 구성이다(완료 알림 · 안내 두 줄 · 다음 행동) — 이 모형의 시안에는
// 은행전송·보증신청 안내가 없어 [알려드려요] 가 두 줄이고, 상단에 모형 코드 뱃지도 없다.
// 기업 화면과 달라지는 것은 브레드크럼과 [홈] 주소뿐이다(기관 IA).
//
...
const OrgInvestmentModelCompletePage = () => (
...
export default OrgInvestmentModelCompletePage
