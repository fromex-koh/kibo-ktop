...
// 기관 개별평가 Tech-Index(창업) 2단계 · 기업정보의 [기업정보 관리] 모달(기업정보 불러오기) — 화면정의서의 하위
...
const OrgTechIndexStartupCompanyManagementPage = () => (
    <>
        ...
        <CompanyInfoLoadDialog
            defaultOpen
            model="tech-index-startup"
            initialResult={getCompanyInfoLoadResult('tech-index-startup')}
        />
    </>
)

export default OrgTechIndexStartupCompanyManagementPage
