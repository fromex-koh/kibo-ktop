...
// 기관 개별평가 Tech-Index(일반) 2단계 · 기업정보의 [기업정보 관리] 모달(기업정보 불러오기) — 화면정의서의 하위
// 화면이라 경로를 따로 둔다. KTRS-FM 화면(ktrs-fm/company-info/company-management)과 같은 구성이고, 불러오는
// 평가모형만 다르다. 모달만 확인하는 자리라 뒤 배경을 비우고 모달을 열어 둔다.
const OrgTechIndexGeneralCompanyManagementPage = () => (
    <>
        ...
        <CompanyInfoLoadDialog
            defaultOpen
            model="tech-index-general"
            initialResult={getCompanyInfoLoadResult('tech-index-general')}
        />
    </>
)

export default OrgTechIndexGeneralCompanyManagementPage
