...
// 기관 개별평가 KTRS-FM 2단계 · 기업정보의 [기업정보 관리] 모달(기업정보 불러오기) — 화면정의서의 하위 화면이라
// 경로를 따로 둔다. 이 화면은 모달만 확인하는 자리라 뒤 배경을 비우고 모달을 열어 둔다 — 다른 모달 단독 화면과
// 같은 방식이다. 버튼이 어디에·어느 모형에 나오는지는 화면만 봐서는 알 수 없어 설명에 함께 적는다.
const OrgKtrsFmCompanyManagementPage = () => (
    <>
        ...
        <CompanyInfoLoadDialog defaultOpen model="ktrs-fm" initialResult={getCompanyInfoLoadResult('ktrs-fm')} />
    </>
)

export default OrgKtrsFmCompanyManagementPage
