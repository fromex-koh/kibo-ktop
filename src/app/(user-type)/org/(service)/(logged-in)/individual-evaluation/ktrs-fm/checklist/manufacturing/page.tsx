...
const COMPLETE_PATH = '/org/individual-evaluation/ktrs-fm/complete'
// 폼 바깥에 있는 [다음] 버튼을 form 속성으로 잇는 이름.
const FORM_ID = 'checklist-form'

// 기관 개별평가 KTRS-FM (3) 체크리스트 입력 — 업종코드가 제조일 때의 화면.
...
const OrgKtrsFmChecklistManufacturingPage = () => (
...
export default OrgKtrsFmChecklistManufacturingPage
