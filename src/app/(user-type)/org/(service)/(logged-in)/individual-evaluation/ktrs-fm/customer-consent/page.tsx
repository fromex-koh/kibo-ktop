...
const OrgKtrsFmCustomerConsentPage = () => (
    <main id="main" tabIndex={-1} className="bg-background flex-1">
        ...
        <div className="grid-layout gap-y-10 pt-7 *:col-span-full md:pt-10">
            ...
            <OrgCustomerConsentForm formId={FORM_ID} nextHref={COMPANY_TECHNOLOGY_INFO_PATH} />
        </div>
...
export default OrgKtrsFmCustomerConsentPage
