...
// 기관 개별평가 KTRS-FM 2단계 · 기업 기타 정보의 [거래유형 설명] 모달 — 화면정의서의 하위 화면이라 경로를 따로 둔다.
...
const OrgKtrsFmTransactionTypeGuidePage = () => (
    <>
...
export default OrgKtrsFmTransactionTypeGuidePage
