...
const MOCK_INQUIRY: InquiryDetailItem = {
    ...
    date: '2026-05-15',
    question:
        '평가 신청 화면에서 "신청하기" 버튼 클릭 시 오류가 발생합니다.\n오류 메시지: "서버 연결 오류가 발생했습니다."\n\n해당 오류가 지속적으로 발생하여 평가 신청이 불가한 상태입니다. 조속한 확인 및 조치 부탁드립니다.',
...
const CorpMypageInquiryDetailPage = () => (
...
export default CorpMypageInquiryDetailPage
