...
const CONSENT_PATH = '/corp/technology-evaluation/tech-index/general/customer-consent'
const COMPLETE_PATH = '/corp/technology-evaluation/tech-index/general/complete'
...
//
// [다음]은 여섯 탭을 모두 검사하고 통과하면 (3) 완료 화면으로 간다.
const CorpTechIndexGeneralCompanyTechnologyInfoPage = () => (
    <main id="main" tabIndex={-1} className="bg-background flex-1">
        ...
        <div className="grid-layout gap-y-10 pt-0 *:col-span-full md:pt-10">
            ...
            <SelfDiagnosisTabsForm
                ...
                tabs={TECH_INDEX_GENERAL_FORM_TABS}
...
export default CorpTechIndexGeneralCompanyTechnologyInfoPage
