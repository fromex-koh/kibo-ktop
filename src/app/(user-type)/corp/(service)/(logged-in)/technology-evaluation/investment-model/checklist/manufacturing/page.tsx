...
// 기업 투자모형 (3) 체크리스트 입력 — 업종코드가 제조일 때의 화면.
// Figma "투자모형_3단계_체크리스트 입력 (제조 선택시)".
//
// 구성은 KTRS-FM 체크리스트 화면과 같다 — 화면은 뼈대만 조립하고, 문항 렌더·검사는 ChecklistForm,
// 문항 글·보기·분기는 MANUFACTURING_CHECKLIST 가 갖는다.
// 이 모형에서 달라지는 것은 문항 내용과 가운데 분기 기준(KTRS-FM 은 기술 구분, 이 화면은 생산 방식)뿐이다.
const CorpInvestmentModelChecklistManufacturingPage = () => (
...
export default CorpInvestmentModelChecklistManufacturingPage
