...
const CONSENT_PATH = '/corp/technology-evaluation/ktrs-fm/customer-consent'
const CHECKLIST_PATH = '/corp/technology-evaluation/ktrs-fm/checklist'
// 폼과 [다음] 버튼을 잇는 이름 — 버튼이 폼 바깥(화면 맨 아래 CTA)에 있어 form 속성으로 연결한다.
const FORM_ID = 'company-technology-info-form'

// 신속표준모형 2단계 — Figma "[신속표준모형 KTRS-FM] 2단계_기업정보 / 대표자 경력사항 / 기업 기타 정보 /
// 핵심 기술 인력 현황 / 기술 개발 실적" 다섯 프레임이 한 화면의 탭 다섯 개다.
// 탭 본문은 전부 composite 의 폼 컴포넌트이고, 이 파일은 화면 뼈대(제목·스텝·탭·CTA)만 조립한다.
const CorpKtrsFmCompanyTechnologyInfoPage = () => (
...
export default CorpKtrsFmCompanyTechnologyInfoPage
