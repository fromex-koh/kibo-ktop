...
// 신속표준모형 3단계 체크리스트 입력 — 화면 뼈대만 조립한다.
// 문항 렌더·검사는 ChecklistForm, 문항 글·보기·분기는 KTRS_FM_CHECKLIST 가 갖는다.
//
...
export default CorpKtrsFmChecklistPage
