...
// 신속표준모형 2단계 · 기업 기타 정보의 [전문기술/숙련기술 정의] 모달 — 화면정의서의 하위 화면이라 경로를 따로 둔다.
...
const CorpKtrsFmTechnologyDefinitionPage = () => (
    <>
...
export default CorpKtrsFmTechnologyDefinitionPage
