...
// 신속표준모형 (3) 체크리스트 입력 — 업종코드가 제조일 때의 화면. 화면 뼈대만 조립한다.
// 문항 렌더·검사는 ChecklistForm, 문항 글·보기·분기는 MANUFACTURING_CHECKLIST 가 갖는다(투자모형과 같은 체크리스트다).
//
...
const CorpKtrsFmChecklistManufacturingPage = () => (
...
export default CorpKtrsFmChecklistManufacturingPage
