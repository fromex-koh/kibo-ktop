...
// ─────────────────────────────────────────────────────────────────────────────────────────────
// 특허 등급조회 — 조회 화면 (corp-patent-evaluation-patent-grade-list · /corp/patent-evaluation/patent-grade-list)
//
...
type CorpPatentGradeListPageProps = {
    searchParams: Promise<Record<string, string | string[] | undefined>>
}

const CorpPatentGradeListPage = async ({searchParams}: CorpPatentGradeListPageProps) => {
...
export default CorpPatentGradeListPage
