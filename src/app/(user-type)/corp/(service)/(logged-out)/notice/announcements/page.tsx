...
const DETAIL_HREF = '/corp/notice/announcements/detail'
...
const MOCK_NOTICE_ITEMS: readonly NoticeItem[] = [
    {
        ...
        isImportant: true,
        isNew: true,
        href: `${DETAIL_HREF}?id=corp-notice-001`,
    },
    {
        id: 'corp-notice-002',
        category: 'service',
        ...
        isImportant: true,
        href: `${DETAIL_HREF}?id=corp-notice-002`,
    },
    {
        id: 'corp-notice-003',
        category: 'system',
        title: '시스템 정기점검 일정을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-003`,
    },
    {
        id: 'corp-notice-004',
        category: 'system',
        title: '로그인 및 회원가입 시스템 변경 안내입니다.',
        href: `${DETAIL_HREF}?id=corp-notice-004`,
    },
    {
        id: 'corp-notice-005',
        category: 'evaluation',
        title: '온라인 기술평가 신청 절차를 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-005`,
    },
    {
        id: 'corp-notice-006',
        category: 'evaluation',
        title: '기술평가 관련 설명회 일정을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-006`,
    },
    {
        id: 'corp-notice-007',
        category: 'payment',
        title: '평가 수수료 결제 수단 추가를 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-007`,
    },
    {
        id: 'corp-notice-008',
        category: 'payment',
        title: '전자세금계산서 발행 일정을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-008`,
    },
    {
        id: 'corp-notice-009',
        category: 'service',
        title: '기업 혁신성장 지원 프로그램을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-009`,
    },
    {
        id: 'corp-notice-010',
        category: 'etc',
        title: '개인정보 처리방침 개정 내용을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-010`,
    },
    {
        id: 'corp-notice-011',
        category: 'etc',
        title: '서비스 이용 중 자주 묻는 사항을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-011`,
    },
    {
        id: 'corp-notice-012',
        category: 'etc',
        title: '기술보증기금 주요 사업 변경사항을 안내드립니다.',
        href: `${DETAIL_HREF}?id=corp-notice-012`,
    },
]
