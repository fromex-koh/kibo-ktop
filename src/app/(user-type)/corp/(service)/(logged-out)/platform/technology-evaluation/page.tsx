...
export const metadata: Metadata = {title: '기술평가 소개'}

// SkipNav의 #main 도착 대상이며 tabIndex={-1}로 키보드 포커스를 받을 수 있다.
// 원고 연동 전까지 표시하는 임시 섹션은 실제 콘텐츠로 교체한다.
const CorpPlatformTechnologyEvaluationPage = () => (
    <main id="main" tabIndex={-1} className="bg-surface flex-1">
        <div className="grid-layout gap-10 pt-10 pb-25 *:col-span-full">
                ...
                breadcrumb={
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbDotSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>기술평가 소개</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                }
            ...
            <section
                ...
                aria-labelledby="platform-technology-evaluation-placeholder-title"
            >
                <h2
                    id="platform-technology-evaluation-placeholder-title"
...
export default CorpPlatformTechnologyEvaluationPage
