    ...
    <main id="main" tabIndex={-1} className="bg-surface flex-1">
        <div className="grid-layout gap-10 pt-10 pb-25 *:col-span-full">
                ...
                breadcrumb={
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>플랫폼 소개</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                }
            ...
            <section
                ...
                aria-labelledby="platform-placeholder-title"
            >
                <h2 id="platform-placeholder-title" className="typo-title-l-bold text-center break-keep">
                    내용 추후 업데이트
                </h2>
            </section>
        </div>
...
export default CorpPlatformPage
