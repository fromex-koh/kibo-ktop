    ...
    <main id="main" tabIndex={-1} className="bg-surface flex-1">
        <div className="grid-layout gap-10 pt-10 pb-25 *:col-span-full">
                ...
                breadcrumb={
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbDotSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>탄소중립 소개</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                }
            ...
            <section
                ...
                aria-labelledby="platform-carbon-neutrality-placeholder-title"
            >
                <h2
                    id="platform-carbon-neutrality-placeholder-title"
...
export default CorpPlatformCarbonNeutralityPage
