...
const CorpPricingPaymentPage = async ({searchParams}: PricingPaymentPageProps) => {
        ...
        <main id="main" tabIndex={-1} className="bg-background flex-1">
            <div className="grid-layout gap-10 pt-10 pb-25 *:col-span-full">
                    ...
                    breadcrumb={
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbLink href="/corp/pricing">가격정책</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbDotSeparator />
                                <BreadcrumbItem>
                ...
                <div className="xl:col-span-8 xl:col-start-3">
                    <PricingPayment plan={plan} userType="corp" />
                </div>
            </div>
        </main>
    )
...
export default CorpPricingPaymentPage
