...
// /corp 일반 서비스 화면의 공통 Shell. (service)는 URL에 포함되지 않는다.
...
// /corp/not-found·/corp/server-error·/corp/maintenance는 이 레이아웃 밖에 두어 풀페이지로 유지한다.
const CorpServiceLayout = ({children}: {children: ReactNode}) => <SubPageLayout>{children}</SubPageLayout>

export default CorpServiceLayout
