...
### 퍼블리싱 인덱스 — 응용2팀 탄소중립 선도기업 2·3차 신청 화면 상태 반영

- 대상: src/content/publishing-guide/publishing-index.json
- 적용: 응용2팀이 올린 상태값을 그대로 받은 것이라 파일을 통째로 덮어씁니다.
- 변경: 탄소중립 선도기업 화면 17개에 응용2 상태 `완료` 가 새로 붙었습니다. 값이 없던 화면에 붙은 것이고 이미 있던 값을 고친 것은 없습니다.
    - 선도기업 신청 2차 — 신청서 작성
    - 선도기업 신청 3차 — 신청서 작성 · 주소 검색
    - 선도기업 신청 3차 — 인벤토리 배출량 산정 · 항목 선택 · Scope설명 · 상세 입력
    - 선도기업 신청 3차 — 목표달성 평가(일반기업 달성·미달성, 목표관리업체 달성·절대배출량 달성·전 기준 미달)
    - 선도기업 신청 3차 — 서류 제출 · 최종 확인 · 제출 확인 팝업 · 신청결과 확인
    - 신청내역 확인 및 확인서 발급
- 진척률: 탄소 응용2 진척률이 50%(37/74)에서 73%(54/74)로 올랐습니다. 기관·기업 화면 수치는 그대로입니다.
