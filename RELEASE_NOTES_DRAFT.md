...
- 보완 집계: 응용2·UIUX 모두 보완을 완료 수에 포함합니다. 진척률 카드는 ‘완료(보완 포함)’로 표시하고, 집계 기준을 표 위 안내 목록에 적었습니다. 취소선 제외 기준은 그대로입니다. 지금은 보완 상태인 화면이 없어 수치는 달라지지 않으며, 앞으로 보완으로 표시하는 화면부터 완료 수에 들어갑니다.
